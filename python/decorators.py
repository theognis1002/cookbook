...
def once_per_minute(func):  # outer function only runs once when we decorate the function
    last_invoked = 0

    def wrapper(*args, **kwargs):  # wrapper and inner function are called each time the function is called
